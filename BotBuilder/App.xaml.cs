...
public partial class App : Application
{
    ...
    /// <summary>The shared settings store. Exposed so MainWindow can build <c>SettingsViewModel</c>
    /// and read <c>ExternalEditorCommand</c> without constructing a second store instance.</summary>
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        var store = new JsonSettingsStore(SettingsPaths.SettingsFile);
        Settings = store;
